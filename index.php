...
<head>
	...
	<title>Proyecto Poliza</title>
</head>
<body background="images/EQUIPO.jpg" style="background-attachment: fixed" >
	...
	<table border="0" align="center" valign="middle">
		...
		<tr><td></td>
			<td width=80 align=center><input class="btn btn-primary" type="submit" value="Aceptar" required=""></td>
			</tr></tr></table>
		</form>
<br>
<!-- formulario registro -->
...
<form method="post" action="" >
  <fieldset>
    ...
    <div class="form-group">
      ...
      <input type="text" name="nick" class="form-control"  required="ingresa el email" placeholder="Ingresa mail"/>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
      ...
      <input type="password" name="rpass" class="form-control" required placeholder="repite contraseña" required="te falto la contraseña" />
    </div>
    <div>
